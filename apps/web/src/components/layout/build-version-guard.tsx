...
export function BuildVersionStamp() {
  return (
    <div
      className="pointer-events-none fixed bottom-2 right-2 z-[90] rounded-full border border-white/20 bg-black/40 px-2 py-0.5 text-[10px] text-pink-200/90 backdrop-blur-sm"
      aria-hidden
    >
      {APP_BUILD_ID}
    </div>
